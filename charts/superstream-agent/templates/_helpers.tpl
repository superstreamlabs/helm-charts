...
{{- default .Chart.Name .Values.superstreamAgent.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{- define "superstream.namespace" -}}
{{- default .Release.Namespace .Values.superstreamAgent.namespaceOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- if .Values.superstreamAgent.fullnameOverride }}
{{- .Values.superstreamAgent.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.superstreamAgent.nameOverride }}
...
{{- $secret := lookup "v1" "Secret" .Release.Namespace .Values.superstreamAgent.secret.name -}}
{{- if $secret -}}
{{ toYaml $secret.data }}
{{- else -}}
...
{{- default (include "superstream.fullname" .) .Values.superstreamAgent.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.superstreamAgent.serviceAccount.name }}
{{- end }}
{{- end }}
